...
//+kubebuilder:rbac:groups=dhcp.bmcgo.dev,resources=dhcphosts,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=dhcp.bmcgo.dev,resources=dhcphosts/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=dhcp.bmcgo.dev,resources=dhcphosts/finalizers,verbs=update
