...
//+kubebuilder:rbac:groups=dhcp.bmcgo.dev,resources=dhcpservers,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=dhcp.bmcgo.dev,resources=dhcpservers/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=dhcp.bmcgo.dev,resources=dhcpservers/finalizers,verbs=update
